...
Route::controller(\App\Http\Controllers\CommentController::class)->group(function () {
    Route::prefix('comment')->group(function () { // comment/route..
        Route::group(['middleware' => ['auth:sanctum']], function () {
            ...
            Route::delete('destroy/{commentCourse_id}', 'destroy'); // still some changes to work right
...
Route::controller(\App\Http\Controllers\CategoryController::class)->group(function () {
    Route::prefix('category')->group(function () {
        ...
        Route::group(['middleware' => ['auth:sanctum']], function () {
            Route::post('store', 'store');
            Route::delete('destroy/{category_id}', 'destroy'); // still some changes to work right
